...
// Tests below require Firebase Auth emulators — skip in normal E2E runs.
// Run with: npm run test:e2e:emulator
test.describe('Shabaka auth flows (emulator required)', () => {
  test.skip(!process.env.NEXT_PUBLIC_USE_EMULATORS, 'Requires Firebase Auth emulators');
  ...
  test('arabic routes stay rtl while technical fields stay ltr', async ({ page }) => {

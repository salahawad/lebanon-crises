...
const VISIBILITY_OPTIONS: { value: VisibilityLevel; labelKey: string; icon: React.ElementType }[] = [
  { value: "public", labelKey: "public", icon: Eye },
  { value: "verified_peers", labelKey: "verifiedPeers", icon: Users },
  { value: "private", labelKey: "private", icon: Lock },
];
  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-center gap-2 rounded-xl border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
        ...
        <span>{tDisclaimer("notReady")}</span>
      </div>
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-bold text-slate-900">{t("profileVisibility")}</h2>
        </div>
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-bold text-slate-900">{t("notificationPreferences")}</h2>
        </div>
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-bold text-slate-900">{t("offlineMode")}</h2>
        </div>
        <div className="bg-white rounded-lg border border-slate-200 p-4">
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-sm font-medium text-slate-800">{t("enableOffline")}</p>
            ...
            <button
              ...
              className={`relative w-12 h-7 rounded-full transition-colors ${
                offlineEnabled ? "bg-success" : "bg-slate-300"
              }`}
            >
              <span
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-bold text-slate-900">{t("regions")}</h2>
        </div>
        <div className="bg-white rounded-lg border border-slate-200 p-4">
          <p className="text-xs text-slate-500 mb-3">
            {t("regionsDesc")}
      ...
      <section className="mb-6">
        <div className="flex items-center gap-2 mb-3">
          ...
          <h2 className="text-base font-bold text-slate-900">{t("dataExport")}</h2>
        </div>
        <div className="bg-white rounded-lg border border-slate-200 p-4">
          <p className="text-xs text-slate-500 mb-4">
            {t("dataExportDesc")}
          ...
          <button
            onClick={handleSave}
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-white font-medium text-sm hover:bg-primary-dark transition-colors"
          >
            {saved ? (
              <>
